...
const AdminMessages = () => {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-[1600px] mx-auto space-y-3">
      {/* ================= HEADER ================= */}
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
        ...
        <button
          ...
          disabled={refreshing}
          className="flex items-center justify-center gap-3 bg-slate-900 hover:bg-slate-800 text-white px-6 py-3.5 rounded-xl font-bold transition disabled:opacity-50"
        >
          <FaSyncAlt
      ...
      <div className="bg-white border border-slate-100 shadow-sm rounded-3xl p-5">
      ...
      <div className="bg-white border border-slate-100 shadow-sm rounded-3xl overflow-hidden">
        {filteredMessages.length === 0 ? (
          <div className="py-24 text-center px-6">
            ...
            <p className="text-slate-500 mt-2">
              No contact messages match your current search or
              filter.
            </p>
          </div>
        ) : (
            ...
            <div className="p-6 md:p-8">
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <DetailCard
                  icon={<FaPhoneAlt />}
                  label="Mobile Number"
                  value={selectedMessage.mobileNumber}
                />
              ...
              <div className="mt-7">
                ...
                <div className="bg-slate-50 border border-slate-100 rounded-2xl p-6 mt-3">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-8">
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-3 bg-yellow-400 hover:bg-yellow-300 text-slate-950 font-black py-4 rounded-xl transition"
                >
                  <FaPhoneAlt />
                  Call Customer
                </a>
                ...
                {selectedMessage.email && (
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-black py-4 rounded-xl transition"
                  >
                    <FaEnvelope />
                    Send Email
                  </a>
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-3 bg-red-50 hover:bg-red-600 text-red-600 hover:text-white font-black px-6 py-4 rounded-xl transition"
                >
                  <FaTrash />
                  Delete
                </button>
